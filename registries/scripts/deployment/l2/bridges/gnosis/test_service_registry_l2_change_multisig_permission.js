...
async function main() {
    ...
    const rawPayloads = [serviceRegistryL2.interface.encodeFunctionData("changeMultisigPermission", ["0x5BA58970c2Ae16Cf6218783018100aF2dCcFc915", false]),
        serviceRegistryL2.interface.encodeFunctionData("changeMultisigPermission", [parsedFile.gnosisSafeSameAddressMultisigImplementationAddress, true])];
    // Pack the second part of data
    const targets = [serviceRegistryL2Address, serviceRegistryL2Address];
    const values = [0, 0];
